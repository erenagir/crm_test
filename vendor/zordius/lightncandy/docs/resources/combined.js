...
ApiGen.config = {
  ...
  name: "ApiGen theme",
  templatesPath:
    "phar:///home/travis/build/zordius/lightncandy/apigen.phar/bin/../vendor/apigen/theme-default/src",
  resources: {
    "phar:///home/travis/build/zordius/lightncandy/apigen.phar/bin/../vendor/apigen/theme-default/src/resources":
      "resources",
  },
  templates: {
    overview: {
      filename: "index.html",
      template:
        "phar:///home/travis/build/zordius/lightncandy/apigen.phar/bin/../vendor/apigen/theme-default/src/overview.latte",
    },
    combined: {
      filename: "resources/combined.js",
      template:
        "phar:///home/travis/build/zordius/lightncandy/apigen.phar/bin/../vendor/apigen/theme-default/src/combined.js.latte",
    },
    elementlist: {
      filename: "elementlist.js",
      template:
        "phar:///home/travis/build/zordius/lightncandy/apigen.phar/bin/../vendor/apigen/theme-default/src/elementlist.js.latte",
    },
    404: {
      filename: "404.html",
      template:
        "phar:///home/travis/build/zordius/lightncandy/apigen.phar/bin/../vendor/apigen/theme-default/src/404.latte",
    },
    package: {
      filename: "package-%s.html",
      template:
        "phar:///home/travis/build/zordius/lightncandy/apigen.phar/bin/../vendor/apigen/theme-default/src/package.latte",
    },
    namespace: {
      filename: "namespace-%s.html",
      template:
        "phar:///home/travis/build/zordius/lightncandy/apigen.phar/bin/../vendor/apigen/theme-default/src/namespace.latte",
    },
    class: {
      filename: "class-%s.html",
      template:
        "phar:///home/travis/build/zordius/lightncandy/apigen.phar/bin/../vendor/apigen/theme-default/src/class.latte",
    },
    constant: {
      filename: "constant-%s.html",
      template:
        "phar:///home/travis/build/zordius/lightncandy/apigen.phar/bin/../vendor/apigen/theme-default/src/constant.latte",
    },
    function: {
      filename: "function-%s.html",
      template:
        "phar:///home/travis/build/zordius/lightncandy/apigen.phar/bin/../vendor/apigen/theme-default/src/function.latte",
    },
    annotationGroup: {
      filename: "annotation-group-%s.html",
      template:
        "phar:///home/travis/build/zordius/lightncandy/apigen.phar/bin/../vendor/apigen/theme-default/src/annotation-group.latte",
    },
    source: {
      filename: "source-%s.html",
      template:
        "phar:///home/travis/build/zordius/lightncandy/apigen.phar/bin/../vendor/apigen/theme-default/src/source.latte",
    },
    tree: {
      filename: "tree.html",
      template:
        "phar:///home/travis/build/zordius/lightncandy/apigen.phar/bin/../vendor/apigen/theme-default/src/tree.latte",
    },
    sitemap: {
      filename: "sitemap.xml",
      template:
        "phar:///home/travis/build/zordius/lightncandy/apigen.phar/bin/../vendor/apigen/theme-default/src/sitemap.xml.latte",
    },
    opensearch: {
      filename: "opensearch.xml",
      template:
        "phar:///home/travis/build/zordius/lightncandy/apigen.phar/bin/../vendor/apigen/theme-default/src/opensearch.xml.latte",
    },
    robots: {
      filename: "robots.txt",
      template:
        "phar:///home/travis/build/zordius/lightncandy/apigen.phar/bin/../vendor/apigen/theme-default/src/robots.txt.latte",
    },
  },
};
    ...
    function request(term, success, failure) {
      ...
      if (data) {
        if (data.length) {
          ...
          var parsed =
            (options.parse && options.parse(options.noRecord)) ||
    ...
    function matchSubset(s, sub) {
      return new RegExp(
        sub
          .toUpperCase()
          .replace(/([\^\$\(\)\[\]\{\}\*\.\+\?\|\\])/gi, "\\$1")
          .replace(/[A-Z0-9]/g, function (m, offset) {
            return offset === 0
              ? "(?:" + m + "|^" + m.toLowerCase() + ")"
              : "(?:.*" + m + "|" + m.toLowerCase() + ")";
          })
...
$(window).load(function () {
  ...
  $search
    .autocomplete(ApiGen.elements, {
      ...
      formatItem: function (data) {
        return data.length > 1
          ? data[1].replace(/^(.+\\)(.+)$/, "<span><small>$1</small>$2</span>")
          : data[0];
      },
      ...
      show: function ($list) {
        ...
        $list
          ...
          .css(
            "left",
            $search.offset().left + $search.outerWidth() - $list.outerWidth()
          );
      },
    })
    .result(function (event, data) {
      ...
      var file = $.sprintf(
        ApiGen.config.templates[autocompleteFiles[data[0]]].filename,
        parts[0].replace(/\(\)/, "").replace(/[^\w]/g, ".")
      );
      if (parts[1]) {
        file +=
          "#" +
          ("mm" === data[0] || "mp" === data[0] ? "m" : "") +
          parts[1].replace(/([\w]+)\(\)/, "_$1");
      }
      location.push(file);
  ...
  if (
    (null === $.cookie("order") &&
      "alphabetical" === ApiGen.config.options.elementsOrder) ||
    "alphabetical" === $.cookie("order")
  ) {
    $caption.click();
  }
  ...
  var splitterPosition = $.cookie("splitter")
    ? parseInt($.cookie("splitter"))
    : null;
  var splitterPositionBackup = $.cookie("splitterBackup")
    ? parseInt($.cookie("splitterBackup"))
    : null;
  ...
  $splitter.mousedown(function () {
    ...
    $document.mousemove(function (event) {
      if (
        event.pageX >= 230 &&
        $document.width() - event.pageX >= 600 + splitterWidth
      ) {
  ...
  $(".l a").click(function (event) {
    ...
    if (event.shiftKey) {
      if (lastLine) {
        for (
          var i = Math.min(selectedLine, lastLine);
          i <= Math.max(selectedLine, lastLine);
          i++
        ) {
          $("#" + i).addClass("selected");
        }
