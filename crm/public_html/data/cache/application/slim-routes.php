<?php return array (
  ...
  array (
    ...
    array (
      ...
      '/api/v1/Email/inbox/notReadCounts' => 'route79',
      '/api/v1/Email/insertFieldData' => 'route80',
      '/api/v1/EmailAddress/search' => 'route82',
      '/api/v1/Oidc/authorizationData' => 'route92',
    ),
    'POST' => 
    array (
      ...
      '/api/v1/Email/importEml' => 'route70',
      '/api/v1/Email/sendTest' => 'route71',
      '/api/v1/Email/inbox/read' => 'route72',
      '/api/v1/Email/inbox/important' => 'route74',
      '/api/v1/Email/inbox/inTrash' => 'route76',
      '/api/v1/UserSecurity/apiKey/generate' => 'route85',
      '/api/v1/UserSecurity/password/recovery' => 'route87',
      '/api/v1/UserSecurity/password/generate' => 'route88',
      '/api/v1/User/passwordChangeRequest' => 'route89',
      '/api/v1/User/changePasswordByRequest' => 'route90',
      '/api/v1/Oidc/backchannelLogout' => 'route93',
    ),
    'PATCH' => 
    array (
    ...
    array (
      ...
      '/api/v1/UserSecurity/password' => 'route86',
    ),
    'DELETE' => 
    array (
  ...
  array (
    ...
    array (
      ...
      1 => 
      array (
        'regex' => '~^(?|/api/v1/MassAction/([^/]+)/status|/api/v1/Export/([^/]+)/status()|/api/v1/Kanban/([^/]+)()()|/api/v1/Attachment/file/([^/]+)()()()|/api/v1/Note/([^/]+)/reactors/([^/]+)()()()|/api/v1/User/([^/]+)/stream/own()()()()()|/api/v1/User/([^/]+)/acl()()()()()()|/api/v1/([^/]+)/([^/]+)()()()()()()|/api/v1/([^/]+)()()()()()()()())$~',
        'routeMap' => 
        array (
          2 => 
          array (
      ...
      2 => 
      array (
        'regex' => '~^(?|/api/v1/([^/]+)/([^/]+)/followers|/api/v1/([^/]+)/([^/]+)/stream()|/api/v1/([^/]+)/([^/]+)/posts()()|/api/v1/([^/]+)/([^/]+)/updateStream()()()|/api/v1/([^/]+)/([^/]+)/streamAttachments()()()()|/api/v1/([^/]+)/([^/]+)/usersAccess()()()()()|/api/v1/([^/]+)/([^/]+)/([^/]+)()()()()())$~',
        'routeMap' => 
        array (
          3 => 
          array (
