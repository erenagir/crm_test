/*! EspoCRM 2025-06-24 */
define("modules/crm/views/meeting/fields/attendees", [
  "exports",
  "views/fields/link-multiple-with-role",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  e.default = void 0;
  t = ((i = t), i && i.__esModule ? i : { default: i });
  var i;
...
define("modules/crm/views/calendar/fields/teams", [
  "exports",
  ...
  class s extends t.default {
    ...
    getSelectBoolFilterList() {
      if ("team" === this.getAcl().getPermissionLevel("userCalendar"))
        return ["onlyMy"];
    }
  }
  e.default = s;
});
define("modules/crm/knowledge-base-helper", ["exports", "ajax"], function (
  e,
  s
) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  e.default = void 0;
  s = ((t = s), t && t.__esModule ? t : { default: t });
  var t;
  e.default = class {
    constructor(e) {
      this.language = e;
...
define("modules/crm/views/task/record/list", [
  "exports",
  "views/record/list",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  ...
  class s extends t.default {
    ...
    actionSetCompleted(e) {
      var t = e.id;
      if (t) {
        t = this.collection.get(t);
        if (t) {
          Espo.Ui.notify(this.translate("saving", "messages"));
          t.save({ status: "Completed" }, { patch: !0 }).then(() => {
...
define("modules/crm/views/record/panels/tasks", [
  "exports",
  "views/record/panels/relationship",
  "helpers/record/create-related",
], function (e, t, i) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  e.default = void 0;
  t = s(t);
  ...
  class a extends t.default {
    ...
    setup() {
      ...
      this.once("show", () => {
        this.isRendered() || this.isBeingRendered() || this.collection.fetch();
      });
      let e = `update-related:${this.link} update-all`;
      "Account" === this.parentScope && (e += " update-related:tasks");
      this.listenTo(this.model, e, () => this.collection.fetch());
    }
    afterRender() {
      this.createView(
        "list",
    ...
    actionCreateTask() {
      let e = this.link;
      "Account" === this.parentScope && (e = "tasks");
      var t = new i.default(this);
      t.process(this.model, e);
    }
    actionComplete(e) {
      var t = e.id;
      if (t) {
...
define("modules/crm/views/record/panels/activities", [
  "exports",
  "views/record/panels/relationship",
  "multi-collection",
  ...
  class a extends t.default {
    ...
    defaultListLayout = {
      rows: [
        ...
        [{ name: "dateStart", soft: !0 }, { name: "assignedUser" }],
      ],
    };
    BUTTON_MAX_COUNT = 3;
    setup() {
      ...
      this.scopeList.forEach((e) => {
        e in this.listLayout || (this.listLayout[e] = this.defaultListLayout);
      });
      this.url =
        this.serviceName +
        "/" +
      ...
      let e = "update-related:activities update-all";
      for (var t of this.scopeList) {
        t = this.entityTypeLinkMap[t];
        t && (e += " update-related:" + t);
      }
      "history" === this.name && (e += " update-related:emails");
      this.listenTo(this.model, e, () => this.collection.fetch());
      this.setFilter(this.filter);
      this.once("show", () => {
        this.isRendered() || this.isBeingRendered() || this.collection.fetch();
    ...
    setupActionList() {
      ...
      this.scopeList.forEach((e) => {
        if (
          ...
          var t = ("history" === this.name ? "Log" : "Schedule") + " " + e,
            i = {
              action: "createActivity",
              text: this.translate(t, "labels", e),
              data: {},
              acl: "create",
              aclScope: e,
            },
          ...
          if (s) {
            i.data.link = s;
            this.entityTypeLinkMap[e] = s;
            if (!this.model.hasLink(s)) return;
          } else {
            i.data.scope = e;
            if (
          ...
          this.createAvailabilityHash[e] = !0;
          i.data = i.data || {};
          if (!i.data.status) {
            s = this.getMetadata().get(["scopes", e, this.name + "StatusList"]);
            s && s.length && (i.data.status = s[0]);
          }
          this.createEntityTypeStatusMap[e] = i.data.status;
          this.actionList.push(i);
          if (
            "activities" === this.name &&
            this.buttonList.length < this.buttonMaxCount
          ) {
            (s = Espo.Utils.cloneDeep(i)),
              (i = this.getMetadata().get(["clientDefs", e, "iconClass"]));
            if (i) {
              s.title = t;
              s.html = $("<span>").addClass(i).get(0).outerHTML;
              this.buttonList.push(s);
            }
          }
        }
      });
    ...
    setupFinalActionList() {
      this.scopeList.forEach((e, t) => {
        ...
        if (this.getAcl().checkScope(e, "read")) {
          var i = {
            action: "viewRelatedList",
            html: $("<span>")
              .append($("<span>").text(this.translate(e, "scopeNamesPlural")))
              .get(0).innerHTML,
            data: { scope: e },
            acl: "read",
            aclScope: e,
    ...
    getCreateActivityAttributes(e, t, i) {
      ...
      if ("User" === this.model.entityType) {
        ...
        if (a.isPortal()) {
          ...
          s.assignedUserId = a.id;
          s.assignedUserName = a.get("name");
        }
      } else {
        if ("Contact" === this.model.entityType) {
          if (this.model.get("accountId") && !this.getConfig().get("b2cMode")) {
            ...
            if (
              e &&
              !this.getMetadata().get(["entityDefs", e, "links", "contacts"]) &&
              !this.getMetadata().get(["entityDefs", e, "links", "contact"])
            ) {
              delete s.parentType;
              delete s.parentId;
              delete s.parentName;
        ...
        } else if ("Lead" === this.model.entityType) {
          s.parentType = "Lead";
    ...
    actionCreateActivity(e) {
      let i = e.link,
        ...
        a;
      if (i) {
        a = this.model.getLinkParam(i, "entity");
        s = this.model.getLinkParam(i, "foreign");
      } else a = e.scope;
      Espo.Ui.notifyWait();
      this.getCreateActivityAttributes(a, e, (e) => {
        var t = new n.default();
        t.showCreate(this, {
          entityType: a,
          relate: i ? { model: this.model, link: s } : void 0,
          attributes: e,
          afterSave: () => {
            this.model.trigger("update-related:" + i);
    ...
    getComposeEmailAttributes(e, t, i) {
      ...
      if (
        ...
        s.nameHash = {};
        s.nameHash[this.model.get("emailAddress")] = this.model.get("name");
      }
      if (e)
        if (s.parentId) {
          if (
        ...
        } else if (this.checkParentTypeAvailability(e, this.model.entityType)) {
          s.parentType = this.model.entityType;
          s.parentId = this.model.id;
          s.parentName = this.model.get("name");
        }
      var a = this.getConfig().get("emailKeepParentTeamsEntityList") || [];
      if (
        s.parentType &&
        s.parentType === this.model.entityType &&
        a.includes(s.parentType) &&
        this.model.get("teamsIds") &&
        this.model.get("teamsIds").length
      ) {
        s.teamsIds = Espo.Utils.clone(this.model.get("teamsIds"));
        s.teamsNames = Espo.Utils.clone(this.model.get("teamsNames") || {});
        a = this.getUser().get("defaultTeamId");
        if (a && !s.teamsIds.includes(a)) {
          s.teamsIds.push(a);
          s.teamsNames[a] = this.getUser().get("defaultTeamName");
        }
      ...
      if (
        ...
        "link" === this.model.getFieldType("account") &&
        "Account" === this.model.getLinkParam("account", "entity")
      ) {
        s.accountId = this.model.attributes.accountId;
        s.accountName = this.model.attributes.accountName;
      }
      if (!s.to && this.isBasePlus()) {
        Espo.Ui.notifyWait();
        Espo.Ajax.getRequest(
          `Activities/${this.model.entityType}/${this.model.id}/composeEmailAddressList`
        ).then((e) => {
          if (e.length) {
            s.to = "";
            s.nameHash = {};
            e.forEach((e) => {
              s.to += e.emailAddress + ";";
              s.nameHash[e.emailAddress] = e.name;
            });
            Espo.Ui.notify(!1);
          }
          i.call(this, s);
    ...
    actionComposeEmail(e) {
      ...
      "emails" in this.model.defs.links &&
        (t = { model: this.model, link: this.model.defs.links.emails.foreign });
      Espo.Ui.notifyWait();
    ...
    actionSetHeld(e) {
      ...
      if (t) {
        t = this.collection.get(t);
        t.save({ status: "Held" }, { patch: !0 }).then(() => {
          this.model.trigger("update-related:activities");
        });
      }
    }
    actionSetNotHeld(e) {
      ...
      if (t) {
        t = this.collection.get(t);
        t.save({ status: "Not Held" }, { patch: !0 }).then(() => {
          this.model.trigger("update-related:activities");
        });
      }
    }
    actionViewRelatedList(e) {
      e.url =
        `Activities/${this.model.entityType}/${this.model.id}/${this.name}/list/` +
        e.scope;
      e.title =
      ...
      var t = e.viewOptions || {},
        i =
          `#${this.model.entityType}/${this.name}/${this.model.id}/` + e.scope;
      t.massUnlinkDisabled = !0;
      t.fullFormUrl = i;
      t.createDisabled = !0;
      e.viewOptions = t;
      super.actionViewRelatedList(e);
    ...
    isBasePlus() {
      var e = this.getMetadata().get(`scopes.${this.model.entityType}.type`);
      return "BasePlus" === e;
    }
  }
  e.default = a;
});
define("modules/crm/views/meeting/detail", [
  "exports",
  "views/detail",
  "moment",
], function (e, t, a) {
  ...
  class s extends t.default {
    ...
    setupStatuses() {
      this.canceledStatusList =
        this.getMetadata().get(
          `scopes.${this.entityType}.canceledStatusList`
        ) || [];
      this.notActualStatusList = [
        ...(this.getMetadata().get(
          `scopes.${this.entityType}.completedStatusList`
        ) || []),
        ...this.canceledStatusList,
      ];
    }
    setupCancellationPeriod() {
      ...
      if (e) {
        e = e.split(" ");
        this.cancellationPeriodAmount = parseInt(e[0]);
        this.cancellationPeriodUnits = e[1] ?? "hours";
      }
    }
    controlAcceptanceStatusButton() {
      if (this.model.has("status") && this.model.has("usersIds"))
        if (this.notActualStatusList.includes(this.model.get("status")))
          ...
          this.model.getLinkMultipleIdList("users").includes(this.getUser().id)
        ) {
          ...
          } else e = this.translate("Acceptance", "labels", "Meeting");
          let i = "";
          if (t) {
            s = {
        ...
        } else this.hideHeaderActionItem("setAcceptanceStatus");
    }
    controlSendInvitationsButton() {
      let e = !0;
      this.notActualStatusList.includes(this.model.get("status")) && (e = !1);
      e && !this.getAcl().checkModel(this.model, "edit") && (e = !1);
      if (e) {
        var t = this.model.getLinkMultipleIdList("users"),
          i = this.model.getLinkMultipleIdList("contacts"),
          s = this.model.getLinkMultipleIdList("leads");
        i.length || s.length || t.length || (e = !1);
      }
      if (e) {
        i = this.model.get("dateEnd");
        i &&
          this.getDateTime().toMoment(i).isBefore(a.default.now()) &&
          (e = !1);
      }
      e
    ...
    controlSendCancellationButton() {
      let e = this.canceledStatusList.includes(this.model.get("status"));
      if (e) {
        var t = this.model.get("dateEnd");
        t &&
          this.getDateTime()
            .toMoment(t)
            .add(this.cancellationPeriodAmount, this.cancellationPeriodUnits)
            .isBefore(a.default.now()) &&
          (e = !1);
      }
      if (e) {
        var t = this.model.getLinkMultipleIdList("users"),
...
define("modules/crm/views/meeting/record/list", [
  "exports",
  "views/record/list",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  ...
  class s extends t.default {
    ...
    async actionSetHeld(e) {
      var t = e.id;
      if (t) {
        t = this.collection.get(t);
        if (t) {
          Espo.Ui.notify(this.translate("saving", "messages"));
          await t.save({ status: "Held" }, { patch: !0 });
          Espo.Ui.success(this.translate("Saved"));
        }
      }
    }
    async actionSetNotHeld(e) {
      var t = e.id;
      if (t) {
        t = this.collection.get(t);
        if (t) {
          Espo.Ui.notify(this.translate("saving", "messages"));
          await t.save({ status: "Not Held" }, { patch: !0 });
          Espo.Ui.success(this.translate("Saved"));
        }
      }
    }
...
define("crm:views/mass-email/record/edit", ["views/record/edit"], function (e) {
  return e.extend({
    setup: function () {
    ...
    initFieldsControl: function () {
      this.listenTo(this.model, "change:smtpAccount", (e, t, i) => {
        if (i.ui)
          if (t && "system" !== t) {
            var s = this.getFieldView("smtpAccount");
            if (s && s.loadedOptionAddresses && s.loadedOptionAddresses[t]) {
              this.model.set("fromAddress", s.loadedOptionAddresses[t]);
              this.model.set("fromName", s.loadedOptionFromNames[t]);
            }
          } else {
            this.model.set(
              "fromAddress",
...
define("modules/crm/views/mass-email/modals/send-test", [
  "exports",
  "views/modal",
  "model",
  ...
  class o extends t.default {
    ...
    setup() {
      ...
      var e = (this.formModel = new i.default()),
    ...
    actionSendTest() {
      let t = [];
      Array.isArray(this.formModel.attributes.usersIds) &&
        this.formModel.attributes.usersIds.forEach((e) => {
          t.push({ id: e, type: "User" });
        });
      Array.isArray(this.formModel.attributes.contactsIds) &&
        this.formModel.attributes.contactsIds.forEach((e) => {
          t.push({ id: e, type: "Contact" });
        });
      Array.isArray(this.formModel.attributes.leadsIds) &&
        this.formModel.attributes.leadsIds.forEach((e) => {
          t.push({ id: e, type: "Lead" });
        });
      Array.isArray(this.formModel.attributes.accountsIds) &&
        this.formModel.attributes.accountsIds.forEach((e) => {
          t.push({ id: e, type: "Account" });
        });
      if (0 === t.length)
        Espo.Ui.error(
          this.translate("selectAtLeastOneTarget", "messages", "MassEmail")
        );
      else {
...
define("crm:views/dashlets/options/chart", [
  ...
  return e.extend({
    ...
    controlDateFilter: function () {
      if ("between" === this.model.get("dateFilter")) {
...
define("crm:views/contact/record/detail", ["views/record/detail"], function (
  e
) {
  return e.extend({});
});
define("modules/crm/views/call/record/list", [
  "exports",
  "views/record/list",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
...
define("modules/crm/views/call/fields/contacts", [
  "exports",
  "modules/crm/views/meeting/fields/attendees",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  e.default = void 0;
  t = ((i = t), i && i.__esModule ? i : { default: i });
  ...
  class s extends t.default {
    ...
    getDetailLinkHtml(e, t) {
      var i = super.getDetailLinkHtml(e, t),
        s = this.foreignScope + "_" + e,
        a = this.model.get("phoneNumbersMap") || {};
      if (!(s in a)) return i;
      (a = a[s]), (s = $(i));
      s.append(
        " ",
        ...
        $("<a>")
          .attr("href", "tel:" + a)
          .attr("data-phone-number", a)
          .attr("data-action", "dial")
          .addClass("small")
          .text(a)
      );
      return $("<div>").append(s).get(0).outerHTML;
    }
  }
  e.default = s;
});
define("modules/crm/views/calendar/modals/edit-view", [
  "exports",
  "views/modal",
  "model",
  "views/record/edit-for-modal",
  ...
  class s extends t.default {
    ...
    setup() {
      let i = this.options.id;
      this.buttonList = [
        { name: "cancel", label: "Cancel", onClick: () => this.actionCancel() },
      ];
      this.isNew = !i;
      var e = this.getPreferences().get("calendarViewDataList") || [];
      if (this.isNew)
      ...
      let s = {};
      if (this.isNew) {
        s.name = this.translate("Shared", "labels", "Calendar");
        let t = 0;
        e.forEach((e) => {
          0 === e.name.indexOf(s.name) && t++;
        });
        t && (s.name += " " + t);
        s.id = i;
        s.teamsIds = this.getUser().get("teamsIds") || [];
        s.teamsNames = this.getUser().get("teamsNames") || {};
      } else
        e.forEach((e) => {
          if (i === e.id) {
            s.teamsIds = e.teamIdList || [];
            s.teamsNames = e.teamNames || {};
            s.id = e.id;
            s.name = e.name;
            s.mode = e.mode;
          }
                ...
                },
                {
                  view: new o.default({
                    ...
                    params: {
                      ...
                      options:
                        this.getMetadata().get(
                          "clientDefs.Calendar.sharedViewModeList"
                        ) || [],
                    },
                  }),
                },
      ...
      this.isNew
        ...
        : (this.headerText =
            this.translate("Edit Shared View", "labels", "Calendar") +
            " · " +
            s.name);
    }
    async actionSave() {
      if (!this.recordView.validate()) {
        ...
        let i = this.getPreferences().get("calendarViewDataList") || [],
          s = {
            name: e.name,
        ...
        if (this.isNew) {
          s.id = Math.random().toString(36).substring(2, 12);
          i.push(s);
        } else {
        ...
        this.options.afterSave && this.options.afterSave(s);
        this.close();
      }
    }
    async actionRemove() {
...
define("modules/crm/views/calendar/fields/users", [
  "exports",
  "views/fields/link-multiple",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
...
define("crm:views/user/record/panels/tasks", [
...
define("modules/crm/views/task/list", ["exports", "views/list"], function (
  e,
  t
) {
  Object.defineProperty(e, "__esModule", { value: !0 });
...
define("modules/crm/views/task/detail", ["exports", "views/detail"], function (
  e,
  t
) {
  Object.defineProperty(e, "__esModule", { value: !0 });
...
define("crm:views/task/record/row-actions/default", [
...
define("crm:views/task/record/row-actions/dashlet", [
  "views/record/row-actions/view-and-edit",
], function (t) {
  return t.extend({
    getActionList: function () {
...
define("modules/crm/views/task/fields/tasks", [
  "exports",
  "views/fields/link-multiple-with-status",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  e.default = void 0;
  t = ((i = t), i && i.__esModule ? i : { default: i });
  ...
  class s extends t.default {
    setup() {
      super.setup();
      this.canceledStatusList =
        this.getMetadata().get("scopes.Task.canceledStatusList") || [];
    }
  }
  e.default = s;
});
define("crm:views/task/fields/priority-for-dashlet", [
  "views/fields/enum",
], function (t) {
  return t.extend({
    data: function () {
      var e = t.prototype.data.call(this);
      (e.style && "default" !== e.style) || (e.isNotEmpty = !1);
      return e;
    },
  });
});
define("modules/crm/views/task/fields/is-overdue", [
  "exports",
  "views/fields/base",
  "moment",
], function (e, t, s) {
  ...
  class a extends t.default {
    ...
    data() {
      let e = !1;
      if (
        -1 === ["Completed", "Canceled"].indexOf(this.model.get("status")) &&
        this.model.has("dateEnd")
      )
        if (this.isDate()) {
          var t = this.model.get("dateEndDate");
          if (t) {
            var t = s.default.utc(
                t + " 23:59",
                this.getDateTime().internalDateTimeFormat
              ),
              i = this.getDateTime().getNowMoment();
            t.unix() < i.unix() && (e = !0);
          }
        } else {
          t = this.model.get("dateEnd");
          if (t) {
            (i = this.getDateTime().toMoment(t)),
              (t = s.default.tz(this.getDateTime().timeZone || "UTC"));
            i.unix() < t.unix() && (e = !0);
          }
        }
      return { isOverdue: e };
...
define("modules/crm/views/task/fields/date-end", [
  "exports",
  ...
  class a extends t.default {
    ...
    data() {
      var e = super.data(),
        t = this.model.attributes.status;
      if (t && !this.notActualStatusList.includes(t)) {
        (this.mode !== this.MODE_DETAIL && this.mode !== this.MODE_LIST) ||
          (this.isDateInPast()
            ? (e.isOverdue = !0)
            : this.isDateToday() && (e.style = "warning"));
        e.isOverdue && (e.style = "danger");
      }
      return e;
    }
    setup() {
    ...
    isDateInPast() {
      if (this.isDate()) {
        let e = this.model.get(this.nameDate);
        if (e) {
          var t = s.default.tz(e + " 23:59", this.getDateTime().getTimeZone()),
            i = this.getDateTime().getNowMoment();
          if (t.unix() < i.unix()) return !0;
        }
      }
      let e = this.model.get(this.name);
      if (e) {
        (t = this.getDateTime().toMoment(e)),
          (i = (0, s.default)().tz(this.getDateTime().timeZone || "UTC"));
        if (t.unix() < i.unix()) return !0;
      }
      return !1;
    }
    isDateToday() {
      return (
        !!this.isDate() &&
        this.getDateTime().getToday() === this.model.attributes[this.nameDate]
      );
    }
  }
  e.default = a;
});
define("crm:views/target-list/record/detail", [
  "views/record/detail",
], function (e) {
  return e.extend({
    setup: function () {
...
define("crm:views/target-list/record/row-actions/opted-out", [
...
define("crm:views/target-list/record/row-actions/default", [
...
define("crm:views/target-list/record/panels/relationship", [
  "views/record/panels/relationship",
], function (e) {
  return e.extend({
...
define("crm:views/target-list/record/panels/opted-out", [
  "views/record/panels/relationship",
  "multi-collection",
], function (e, t) {
  return e.extend({
    ...
    setup: function () {
      this.seeds = {};
      var e =
        this.getMetadata().get(["scopes", "TargetList", "targetLinkList"]) ||
        [];
      this.scopeList = [];
      e.forEach((e) => {
...
define("crm:views/target-list/fields/target-status", [
  "views/fields/base",
], function (e) {
  return e.extend({
...
define("crm:views/target-list/fields/including-action-list", [
...
define("modules/crm/views/stream/notes/event-confirmation", [
  "exports",
  "views/stream/note",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
...
define("crm:views/record/row-actions/tasks", [
...
define("crm:views/record/row-actions/relationship-target", [
...
define("crm:views/record/row-actions/history", [
  "views/record/row-actions/relationship",
], function (e) {
  return e.extend({
    getActionList: function () {
...
define("crm:views/record/row-actions/activities", [
  "views/record/row-actions/relationship",
], function (e) {
  return e.extend({
    getActionList: function () {
...
define("crm:views/record/row-actions/activities-dashlet", [
  "views/record/row-actions/view-and-edit",
], function (i) {
  return i.extend({
    getActionList: function () {
      ...
      e.forEach(function (e) {
        e.data = e.data || {};
        e.data.scope = this.model.entityType;
      }, this);
      if ("Task" === t)
        this.options.acl.edit &&
          !~["Completed", "Canceled"].indexOf(this.model.get("status")) &&
...
define("crm:views/record/panels/target-lists", [
  "views/record/panels/relationship",
], function (e) {
  return e.extend({
    actionOptOut: function (e) {
...
define("modules/crm/views/record/panels/history", [
  "exports",
  ...
  class n extends t.default {
    ...
    actionArchiveEmail(e) {
      let i = null;
      this.model.hasLink("emails") &&
        (i = {
          model: this.model,
          link: this.model.getLinkParam("emails", "foreign"),
        });
      this.getArchiveEmailAttributes("Email", e, (e) => {
        var t = new s.default();
        t.showCreate(this, {
          entityType: "Email",
          attributes: e,
...
define("crm:views/opportunity/record/list", ["views/record/list"], function (
  e
) {
  return e.extend({});
});
define("crm:views/opportunity/record/kanban", [
  "views/record/kanban",
], function (e) {
  return e.extend({
    handleAttributesOnGroupChange: function (e, t, i) {
      if ("stage" === this.statusField) {
...
define("modules/crm/views/opportunity/record/edit", [
  "exports",
  "views/record/edit",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
...
define("modules/crm/views/opportunity/record/edit-small", [
  "exports",
...
define("crm:views/opportunity/record/panels/activities", [
  "crm:views/record/panels/activities",
], function (s) {
  return s.extend({
    getComposeEmailAttributes: function (e, t, i) {
      t = t || {};
      Espo.Ui.notifyWait();
      s.prototype.getComposeEmailAttributes.call(this, e, t, (t) => {
        Espo.Ajax.getRequest(
          ...
          e.forEach((e) => {
            t.to += e.emailAddress + ";";
            t.nameHash[e.emailAddress] = e.name;
          });
          Espo.Ui.notify(!1);
          i.call(this, t);
        });
...
define("crm:views/opportunity/fields/stage", ["views/fields/enum"], function (
  e
) {
  return e.extend({
    setup: function () {
...
define("crm:views/opportunity/fields/lead-source", [
  "views/fields/enum",
], function (e) {
  return e.extend({});
});
define("modules/crm/views/opportunity/fields/last-stage", [
  "exports",
  "views/fields/enum",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
...
define("crm:views/opportunity/fields/contact-role", [
  "views/fields/enum",
], function (e) {
  return e.extend({ searchTypeList: ["anyOf", "noneOf"] });
});
define("modules/crm/views/opportunity/admin/field-manager/fields/probability-map", [
  "exports",
  "views/fields/base",
  "jquery",
], function (e, t, i) {
  ...
  class a extends t.default {
    ...
    data() {
      var e = {},
        t = this.model.get("probabilityMap") || {};
      e.stageList = this.model.get("options") || [];
      e.values = t;
      return e;
    }
    fetch() {
      ...
      (this.model.get("options") || []).forEach((e) => {
        t.probabilityMap[e] = parseInt(
          (0, i.default)(this.element).find(`input[data-name="${e}"]`).val()
        );
      });
      return t;
    }
...
define("crm:views/notification/items/event-attendee", [
  ...
  return e.extend({
    ...
    setup: function () {
      ...
      this.messageData.entityType = this.translateEntityType(e.entityType);
...
define("modules/crm/views/meeting/popup-notification", [
  "exports",
  ...
  class s extends t.default {
    ...
    setup() {
      if (this.notificationData.entityType) {
        var e = this.getModelFactory().create(
          this.notificationData.entityType,
          (e) => {
            var t = this.notificationData.dateField,
              i = e.getFieldParam(t, "type") || "base",
              i = this.getFieldManager().getViewName(i);
            e.set(this.notificationData.attributes);
            this.createView("date", i, {
              model: e,
              mode: "detail",
...
define("modules/crm/views/meeting/record/edit-small", [
  "exports",
  "views/record/edit",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
...
define("modules/crm/views/meeting/record/detail", [
  "exports",
  "views/record/detail",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  ...
  class s extends t.default {
    ...
    setupActionItems() {
      ...
      if (
        ...
        var e =
          this.getMetadata().get(
            `scopes.${this.entityType}.historyStatusList`
          ) || [];
        if (e.includes("Held") && e.includes("Not Held")) {
          this.dropdownItemList.push({
            label: "Set Held",
            name: "setHeld",
    ...
    manageAccessEdit(e) {
      super.manageAccessEdit(e);
      if (e && !this.getAcl().checkModel(this.model, "edit", !0)) {
...
define("crm:views/meeting/record/row-actions/default", [
  "views/record/row-actions/view-and-edit",
], function (t) {
  return t.extend({
    getActionList: function () {
...
define("crm:views/meeting/record/row-actions/dashlet", [
  "views/record/row-actions/view-and-edit",
], function (t) {
  return t.extend({
    getActionList: function () {
...
define("crm:views/meeting/record/panels/scheduler", [
  ...
  return t.extend({
    ...
    setup: function () {
      t.prototype.setup.call(this);
      var e =
        this.getMetadata().get(["clientDefs", this.scope, "schedulerView"]) ||
...
define("crm:views/meeting/record/panels/attendees", [
...
define("crm:views/meeting/modals/send-invitations", [
  "views/modal",
  "collection",
], function (e, t) {
  return e.extend({
...
define("crm:views/meeting/modals/send-cancellation", [
  "views/modal",
  "collection",
], function (e, t) {
  return e.extend({
      ...
      this.wait(
        this.collection
          ...
          .then((e) => {
            this.collection.models
              .filter(
                (e) => e.id !== this.getUser().id || "User" !== e.entityType
              )
              .forEach((e) => {
                this.getListView().checkRecord(e.id);
              });
...
define("modules/crm/views/meeting/modals/detail", [
  "exports",
  "moment",
  "views/modals/detail",
], function (e, s, t) {
  ...
  class a extends t.default {
    ...
    getAcceptanceButtonData() {
      var e = this.model.getLinkMultipleColumn(
        "users",
        "status",
        this.getUser().id
      );
      let t,
        ...
        s = null;
      if (e && "None" !== e) {
        t = this.getLanguage().translateOption(
          e,
          "acceptanceStatus",
          this.model.entityType
        );
        ...
        t =
          void 0 !== e
            ...
            : " ";
      let n = this.getHelper().escapeString(t);
      s && (n = s + " " + n);
      return { style: i, text: t, html: n };
    }
    showAcceptanceButton() {
      this.showActionItem("setAcceptanceStatus");
      if (this.isRendered()) {
        var e = this.getAcceptanceButtonData(),
          t = this.$el.find('.modal-footer [data-name="setAcceptanceStatus"]');
        t.html(e.html);
    ...
    isSendInvitationsToBeDisplayed() {
      ...
      return !(
        this.notActualStatusList.includes(this.model.get("status")) ||
        ((e = this.model.get("dateEnd")),
        e && this.getDateTime().toMoment(e).isBefore(s.default.now())) ||
        !this.getAcl().checkModel(this.model, "edit") ||
        ((e = this.model.getLinkMultipleIdList("users")),
        (t = this.model.getLinkMultipleIdList("contacts")),
        (i = this.model.getLinkMultipleIdList("leads")),
        !(t.length || i.length || e.length))
      );
    }
    actionSendInvitations() {
      Espo.Ui.notifyWait();
...
define("crm:views/meeting/modals/acceptance-status", ["views/modal"], function (
  t
) {
  return t.extend({
    backdrop: !0,
    ...
    actionSetStatus: function (e) {
      this.trigger("set-status", e.status);
      this.close();
    },
  });
});
define("modules/crm/views/meeting/fields/users", [
  "exports",
  "modules/crm/views/meeting/fields/attendees",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  ...
  class s extends t.default {
    ...
    getIconHtml(e) {
      return this.getHelper().getAvatarHtml(e, "small", 18, "avatar-link");
    }
    prepareEditItemElement(e, t) {
      var i = super.prepareEditItemElement(e, t),
        s = this.getHelper().getAvatarHtml(e, "small", 18, "avatar-link");
      if (s) {
        var s = new DOMParser().parseFromString(s, "text/html").body
            .childNodes[0],
          a = i.children[0].querySelector(".link-item-name");
        a && a.prepend(s);
      }
      return i;
    }
...
define("modules/crm/views/meeting/fields/reminders", [
  "exports",
  "ui/select",
  "moment",
  "views/fields/base",
  ...
  class a extends t.default {
    ...
    events = {
      ...
      'click [data-action="removeReminder"]': function (e) {
        var t = $(e.currentTarget).closest(".reminder"),
          i = t.index();
        t.remove();
    ...
    setup() {
      ...
      this.typeList = Espo.Utils.clone(
        this.getMetadata().get("entityDefs.Reminder.fields.type.options") || []
      );
      this.secondsList = Espo.Utils.clone(
        this.getMetadata().get("entityDefs.Reminder.fields.seconds.options") ||
          []
      );
      this.dateField =
        this.model.getFieldParam(this.name, "dateField") || this.dateField;
    ...
    setupReminderList() {
      if (
        ...
        let e = "defaultReminders";
        "Task" === this.model.entityType && (e = "defaultRemindersTask");
        this.reminderList = this.getPreferences().get(e) || [];
      } else this.reminderList = this.model.get(this.name) || [];
    ...
    updateType(e, t) {
      this.reminderList[t].type = e;
      this.trigger("change");
    }
    updateSeconds(e, t) {
      this.reminderList[t].seconds = e;
      this.trigger("change");
    }
    addItemHtml(t) {
      var e = $("<div>").addClass("input-group").addClass("reminder");
      let i = $("<select>")
        .attr("name", "type")
        .attr("data-name", "type")
      ...
      let s = $("<select>")
        ...
        n = this.model.get(this.dateField)
          ? this.getDateTime().toMoment(this.model.get(this.dateField))
          : null;
      var a = Espo.Utils.clone(this.secondsList);
      a.includes(t.seconds) || a.push(t.seconds);
      a.filter((e) => e === t.seconds || !n || this.isBefore(e, n))
        .sort((e, t) => e - t)
        .forEach((e) => {
          var t = $("<option>").attr("value", e).text(this.stringifySeconds(e));
          s.append(t);
        });
      s.val(t.seconds);
      s.on("change", () => {
      ...
      e.append($('<div class="input-group-item">').append(i))
        .append($('<div class="input-group-item">').append(s))
        .append($('<div class="input-group-btn">').append(a));
      ...
      o.default.init(s, {
        ...
        load: (e, t) => {
          ...
          if (!(isNaN(i) || i < 0 || 59 < i)) {
            var s = [],
              a = 60 * i;
            if (this.isBefore(a, n)) {
              s.push({ value: a.toString(), text: this.stringifySeconds(a) });
              if (i <= 24) {
                a = 3600 * i;
                this.isBefore(a, n) &&
                  s.push({
                    value: a.toString(),
                    text: this.stringifySeconds(a),
                  });
              }
              if (i <= 30) {
                a = 3600 * i * 24;
    ...
    isBefore(e, t) {
      return i.default.utc().add(e, "seconds").isBefore(t);
    }
    stringifySeconds(e) {
      if (!e) return this.translate("on time", "labels", "Meeting");
      var t = e,
        i = Math.floor(t / 86400),
        s = ((t %= 86400), Math.floor(t / 3600)),
        a = ((t %= 3600), Math.floor(t / 60)),
        t = t % 60,
        n = [];
      i && n.push(i + "" + this.getLanguage().translate("d", "durationUnits"));
      s && n.push(s + "" + this.getLanguage().translate("h", "durationUnits"));
      a && n.push(a + "" + this.getLanguage().translate("m", "durationUnits"));
      t && n.push(t + "" + this.getLanguage().translate("s", "durationUnits"));
      return n.join(" ") + " " + this.translate("before", "labels", "Meeting");
    }
    getDetailItemHtml(e) {
      return $("<div>")
        .append(
    ...
    fetch() {
      var e = {};
      e[this.name] = Espo.Utils.cloneDeep(this.reminderList);
      return e;
    }
  }
  e.default = a;
});
define("modules/crm/views/meeting/fields/date-start", [
  "exports",
  "views/fields/datetime-optional",
  "moment",
], function (e, t, n) {
  ...
  class s extends t.default {
    ...
    data() {
      ...
      !t ||
        this.notActualStatusList.includes(t) ||
        (this.mode !== this.MODE_DETAIL && this.mode !== this.MODE_LIST) ||
        (this.isDateInPast("dateEnd")
          ? (e = "danger")
          : this.isDateInPast("dateStart", !0) && (e = "warning"));
      return { ...super.data(), style: e };
    }
    isDateInPast(t, i) {
      if (this.isDate()) {
        let e = this.model.get(t + "Date");
        if (e) {
          var s = i ? e + " 00:00" : e + " 23:59",
            s = n.default.tz(s, this.getDateTime().getTimeZone()),
            a = this.getDateTime().getNowMoment();
          if (s.unix() < a.unix()) return !0;
        }
      } else {
        let e = this.model.get(t);
        if (e) {
          (s = this.getDateTime().toMoment(e)),
            (a = (0, n.default)().tz(this.getDateTime().timeZone || "UTC"));
          if (s.unix() < a.unix()) return !0;
        }
      }
      return !1;
    ...
    fetch() {
      var e = super.fetch();
      e[this.nameDate] ? (e.isAllDay = !0) : (e.isAllDay = !1);
      return e;
    }
    controlTimePartVisibility() {
      if (this.isEditMode() && this.isInlineEditMode())
...
define("crm:views/meeting/fields/date-end", [
  "views/fields/datetime-optional",
], function (e) {
  return e.extend({
      ...
      this.listenTo(this.model, "change:isAllDay", (e, t, i) => {
        if (i.ui && this.isEditMode())
          if (void 0 !== this.isAllDayValue || t) {
            this.isAllDayValue = t;
            if (t) this.$time.val(this.noneOption);
            else {
              let e = this.model.get("dateStart");
              e = e || this.getDateTime().getNow(5);
              var s = this.getDateTime().toMoment(e),
                s =
                  ((e = s.format(this.getDateTime().getDateTimeFormat())),
                  e.indexOf(" ")),
                s = e.substring(s + 1);
              this.model.get("dateEnd") && this.$time.val(s);
            }
            this.trigger("change");
...
define("modules/crm/views/meeting/fields/contacts", [
  "exports",
  "modules/crm/views/meeting/fields/attendees",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
...
define("modules/crm/views/meeting/fields/acceptance-status", [
  "exports",
  "views/fields/enum",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
...
define("modules/crm/views/mass-email/detail", [
  "exports",
  "views/detail",
  ...
  class a extends t.default {
    ...
    async actionSendTest() {
      var e = new i.default({ model: this.model });
      await this.assignView("modal", e);
      await e.render();
    }
  }
  e.default = a;
});
define("modules/crm/views/mass-email/record/list-for-campaign", [
  "exports",
  "views/record/list",
  "crm:views/mass-email/modals/send-test",
], function (e, t, i) {
  ...
  class a extends t.default {
    async actionSendTest(e) {
      var t = e.id,
        t = this.collection.get(t);
      if (t) {
        t = new i.default({ model: t });
...
define("crm:views/mass-email/record/detail", ["views/record/detail"], function (
  e
) {
  return e.extend({
    duplicateAction: !0,
...
define("crm:views/mass-email/record/detail-bottom", [
...
define("crm:views/mass-email/fields/email-template", [
  "views/fields/link",
], function (e) {
  return e.extend({
...
define("modules/crm/views/lead/detail", ["exports", "views/detail"], function (
  e,
  t
) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  ...
  class s extends t.default {
    ...
    isConvertable() {
      var e = [
        ...(this.getMetadata().get(
          "entityDefs.Lead.fields.status.notActualOptions"
        ) || []),
        "Converted",
      ];
      return !e.includes(this.model.get("status")) && this.model.has("status");
    }
    actionConvert() {
...
define("modules/crm/views/lead/convert", ["exports", "views/main"], function (
  e,
  t
) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  ...
  class s extends t.default {
    ...
    setup() {
      this.scope = "Lead";
      this.addHandler("change", "input.check-scope", (e, t) => {
        var i = t.dataset.scope,
          i = this.$el.find(".edit-container-" + Espo.Utils.toDom(i));
        t.checked ? i.removeClass("hide") : i.addClass("hide");
      });
      ...
      this.getModelFactory().create("Lead", (e) => {
        this.model = e;
        e.id = this.id;
        this.listenToOnce(e, "sync", () => this.build());
        e.fetch();
      });
    }
    build() {
      let a = (this.scopeList = []),
        n =
          ((
            ...
            ("Account" === e && this.getConfig().get("b2cMode")) ||
              ...
              (this.getAcl().check(e, "create") && a.push(e));
          }),
          0);
      0 === a.length
        ? this.wait(!1)
    ...
    convert() {
      ...
      if (0 === a.length)
        ...
        i ? Espo.Ui.error(this.translate("Not valid")) : s(t);
      }
    }
    getHeader() {
      var e = this.getHeaderIconHtml(),
        t = this.getLanguage().translate(
          this.model.entityType,
          "scopeNamesPlural"
        ),
        t = $("<span>").append($("<a>").attr("href", "#Lead").text(t)),
        e = (e && t.prepend(e), this.model.get("name") || this.model.id),
        i = `#${this.model.entityType}/view/` + this.model.id,
        i = $("<a>")
          .attr("href", i)
          .addClass("action")
          .append($("<span>").text(e));
...
define("modules/crm/views/lead/record/detail", [
  "exports",
  "views/record/detail",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  ...
  class s extends t.default {
    ...
    getSelfAssignAttributes() {
      if ("New" === this.model.attributes.status) {
        ...
        if (e.includes("Assigned")) return { status: "Assigned" };
      }
      return {};
    }
  }
...
define("crm:views/lead/record/detail-side", [
  "views/record/detail-side",
], function (e) {
  return e.extend({ setupPanels: function () {} });
});
define("crm:views/lead/record/panels/converted-to", [
  "views/record/panels/side",
], function (e) {
  return e.extend({
    setupFields: function () {
...
define("crm:views/lead/fields/created-opportunity", [
  "views/fields/link",
], function (e) {
  return e.extend({
...
define("crm:views/lead/fields/created-contact", [
  "views/fields/link",
], function (e) {
  return e.extend({
    getSelectFilters: function () {
...
define("crm:views/lead/fields/acceptance-status", [
...
define("crm:views/knowledge-base-article/list", [
  "views/list-with-categories",
], function (e) {
  return e.extend({ categoryScope: "KnowledgeBaseCategory" });
});
define("crm:views/knowledge-base-article/record/list", [
  "views/record/list",
], function (e) {
  return e.extend({});
});
define("crm:views/knowledge-base-article/record/edit", [
  "views/record/edit",
], function (e) {
  return e.extend({ saveAndContinueEditingAction: !0 });
});
define("crm:views/knowledge-base-article/record/edit-quick", [
  "views/record/edit-small",
], function (e) {
  return e.extend({ isWide: !0, sideView: !1 });
});
define("modules/crm/views/knowledge-base-article/record/detail", [
  "exports",
  ...
  class a extends i.default {
    ...
    actionSendInEmail() {
      Espo.Ui.notifyWait();
      var e = new t.default(this.getLanguage());
      e.getAttributesForEmail(this.model, {}, (e) => {
        ...
        this.createView(
          "composeEmail",
          t,
          { attributes: e, selectTemplateDisabled: !0, signatureDisabled: !0 },
          (e) => {
            Espo.Ui.notify(!1);
            e.render();
          }
...
define("crm:views/knowledge-base-article/record/detail-quick", [
...
define("crm:views/knowledge-base-article/fields/status", [
  "views/fields/enum",
], function (t) {
  return t.extend({
    setup: function () {
      ...
      var e = !1;
      this.on("change", () => {
        if ("Published" === this.model.get("status")) {
          if (!this.model.get("publishDate")) {
            e = !0;
            this.model.set("publishDate", this.getDateTime().getToday());
          }
        } else e && this.model.set("publishDate", null);
      });
    },
  });
});
define("crm:views/knowledge-base-article/fields/language", [
  "views/fields/enum",
], function (e) {
  return e.extend({
    setupOptions: function () {
...
define("crm:views/event-confirmation/confirmation", ["view"], function (e) {
  return e.extend({
    ...
    getActionDataList: function () {
      ...
      var e = ["Accepted", "Tentative", "Declined"];
    ...
    convertDateTime: function (e) {
      var t = this.getConfig().get("timeZone"),
        t = this.getDateTime().toMoment(e).tz(t);
      return (
        t.format(this.getDateTime().getDateTimeFormat()) + " " + t.format("Z z")
      );
    },
  });
});
...
define("crm:views/email-queue-item/record/list", [
  "views/record/list",
], function (e) {
  return e.extend({ rowActionsView: "views/record/row-actions/remove-only" });
});
define("crm:views/document/list", ["views/list-with-categories"], function (e) {
  return e.extend({ categoryScope: "DocumentFolder" });
});
define("crm:views/document/modals/select-records", [
  "views/modals/select-records-with-categories",
], function (e) {
  return e.extend({ categoryScope: "DocumentFolder" });
});
define("crm:views/document/fields/name", ["views/fields/varchar"], function (
  e
) {
  return e.extend({
    setup: function () {
...
define("crm:views/dashlets/tasks", [
...
define("crm:views/dashlets/meetings", [
  "views/dashlets/abstract/record-list",
], function (e) {
  return e.extend({
    name: "Meetings",
...
define("crm:views/dashlets/calls", [
  "views/dashlets/abstract/record-list",
], function (e) {
  return e.extend({
    name: "Calls",
...
define("modules/crm/views/dashlets/calendar", [
  "exports",
  ...
  class s extends t.default {
    ...
    afterRender() {
      var i = this.getOption("mode");
      if ("timeline" === i) {
        let t = [];
        var s = this.getOption("usersIds") || [];
        let i = this.getOption("usersNames") || {},
          e =
            (s.forEach((e) => {
        ...
        let e = null,
          t =
            (["basicWeek", "month", "basicDay"].includes(i) &&
              (e = this.getOption("teamsIds")),
            this.getMetadata().get([
              "clientDefs",
              "Calendar",
              "calendarView",
        ...
        this.createView(
          ...
          t,
          {
            ...
            teamIdList: e,
            scrollToNowSlots: 3,
            suppressLoadingAlert: !0,
          },
          (i) => {
            this.listenTo(i, "view", () => {
              if ("month" === this.getOption("mode")) {
                var e = this.getOption("title"),
                  e = $("<span>").append(
                    $("<span>").text(e),
                    ' <span class="chevron-right"></span> ',
                    $("<span>").text(i.getTitle())
                  ),
                  t = this.$el
                    .closest(".panel")
    ...
    setupButtonList() {
      if ("timeline" !== this.getOption("mode")) {
        this.buttonList.push({
          name: "previous",
    ...
    autoRefresh() {
      var e = this.getCalendarView();
      e && e.actionRefresh({ suppressLoadingAlert: !0 });
    }
    actionNext() {
      var e = this.getCalendarView();
      e && e.actionNext();
...
define("modules/crm/views/dashlets/activities", [
  "exports",
  "views/dashlets/abstract/base",
  "multi-collection",
  "helpers/record-modal",
  ...
  class n extends t.default {
    ...
    defaultListLayout = {
      rows: [
        ...
        [{ name: "dateStart", soft: !0 }, { name: "parent" }],
      ],
    };
    ...
    afterRender() {
      ...
      this.getOption("includeShared") &&
        (this.collection.data.includeShared = !0);
      this.listenToOnce(this.collection, "sync", () => {
        this.createView(
          "list",
    ...
    autoRefresh() {
      this.refreshInternal({ skipNotify: !0 });
    }
    async refreshInternal() {
      var e =
        0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {};
      e.skipNotify || Espo.Ui.notifyWait();
      await this.collection.fetch({
      ...
      e.skipNotify || Espo.Ui.notify();
    }
    actionCreateActivity(e) {
      var t = e.scope,
        i = {},
        s = (this.populateAttributesAssignedUser(t, i), new a.default());
      s.showCreate(this, {
        entityType: t,
        attributes: i,
        afterSave: () => {
    ...
    actionCreateMeeting() {
      var e = {},
        t =
          (this.populateAttributesAssignedUser("Meeting", e), new a.default());
      t.showCreate(this, {
        entityType: "Meeting",
        attributes: e,
        afterSave: () => {
    ...
    actionCreateCall() {
      var e = {},
        t = (this.populateAttributesAssignedUser("Call", e), new a.default());
      t.showCreate(this, {
        entityType: "Call",
        attributes: e,
        afterSave: () => {
...
define("crm:views/dashlets/options/sales-pipeline", [
...
define("crm:views/dashlets/options/calendar", [
  "views/dashlets/options/base",
], function (e) {
  return e.extend({
    setup: function () {
    ...
    manageFields: function (e, t, i) {
      ...
      if (
        "no" !== this.getAcl().getPermissionLevel("userCalendar") &&
...
define("crm:views/dashlets/options/activities", [
  "views/dashlets/options/base",
], function (i) {
  return i.extend({
    init: function () {
...
define("crm:views/dashlets/options/sales-pipeline/fields/team", [
  "views/fields/link",
], function (e) {
  return e.extend({
...
define("modules/crm/views/contact/detail", [
  "exports",
  "views/detail",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
...
define("crm:views/contact/record/detail-small", [
  "views/record/detail-small",
  "crm:views/contact/record/detail",
], function (e, t) {
  return e.extend({});
});
define("modules/crm/views/contact/modals/select-for-portal-user", [
  "exports",
...
define("crm:views/contact/fields/title", ["views/fields/varchar"], function (
  e
) {
  return e.extend({
    setupOptions: function () {
...
define("crm:views/contact/fields/opportunity-role", [
  "views/fields/enum",
], function (e) {
  return e.extend({ searchTypeList: ["anyOf", "noneOf"] });
});
define("crm:views/contact/fields/name-for-account", [
...
define("modules/crm/views/contact/fields/accounts", [
  "exports",
  ...
  class s extends t.default {
    ...
    getValueForDisplay() {
      if (this.isDetailMode() || this.isListMode()) {
        let t = [];
        this.primaryId &&
          t.push(this.getDetailLinkHtml(this.primaryId, this.primaryName));
        this.ids.forEach((e) => {
        ...
        return t
          .map(
            (e) =>
              $("<div>").addClass("link-multiple-item").html(e).get(0).outerHTML
          )
          .join("");
      }
    }
    getDetailLinkHtml(e, t) {
      ...
      if (this.getColumnValue(e, "isInactive")) {
        var s = $("<div>").html(i);
        s.find("a").css("text-decoration", "line-through");
        return s.get(0).innerHTML;
      }
      return i;
    }
    afterAddLink(e) {
      super.afterAddLink(e);
      if (1 === this.ids.length) {
        this.primaryId = e;
        this.primaryName = this.nameHash[e];
      }
      this.controlPrimaryAppearance();
    }
    afterDeleteLink(e) {
      super.afterDeleteLink(e);
    ...
    controlPrimaryAppearance() {
      ...
      this.primaryId &&
        this.$el
          .find('li.set-primary-list-item[data-id="' + this.primaryId + '"]')
          .addClass("hidden");
    }
    addLinkHtml(e, t) {
      t = t || e;
      if (this.isSearchMode()) return super.addLinkHtml(e, t);
      var i = super.addLinkHtml(e, t),
        s = e === this.primaryId,
        a = $("<a>")
          .attr("role", "button")
          .attr("tabindex", "0")
        ...
        a = $("<li>")
          ...
          .attr("data-id", e)
          .append(a);
      (!s && 1 !== this.ids.length) || a.addClass("hidden");
      i.find("ul.dropdown-menu").append(a);
      this.getColumnValue(e, "isInactive") &&
        i.find("div.link-item-name").css("text-decoration", "line-through");
    }
    fetch() {
      var e = super.fetch();
...
define("crm:views/contact/fields/account", ["views/fields/link"], function (t) {
  return t.extend({
    getAttributeList: function () {
      var e = t.prototype.getAttributeList.call(this);
      e.push("accountIsInactive");
      return e;
    },
    afterRender: function () {
...
define("crm:views/contact/fields/account-role", [
  "views/fields/varchar",
], function (t) {
  return t.extend({
...
define("modules/crm/views/case/record/detail", [
  "exports",
  "views/record/detail",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
...
define("crm:views/case/record/panels/activities", [
  "crm:views/record/panels/activities",
], function (i) {
  return i.extend({
    getComposeEmailAttributes: function (e, t, s) {
      ...
      i.prototype.getComposeEmailAttributes.call(this, e, t, (i) => {
        i.name =
          "[#" + this.model.get("number") + "] " + this.model.get("name");
        Espo.Ajax.getRequest(
...
define("crm:views/campaign-tracking-url/record/edit", [
  "views/record/edit",
], function (e) {
  return e.extend({});
});
define("crm:views/campaign-tracking-url/record/edit-small", [
  "views/record/edit-small",
], function (e) {
  return e.extend({});
});
define("crm:views/campaign-log-record/fields/data", [
  "views/fields/base",
], function (e) {
  return e.extend({
      ...
      switch (e) {
        ...
        case "Opted Out":
          return $("<span>")
            ...
            .get(0).outerHTML;
        case "Bounced":
          var t = this.model.get("stringData"),
            i = this.model.get("stringAdditionalData"),
            s =
              "Hard" === i
          ...
          return $("<span>")
            .append(
              $("<span>").addClass("label label-default").text(s),
              " ",
              $("<s>")
                .text(t)
                .addClass("Hard" === i ? "text-danger" : "")
            )
            .get(0).outerHTML;
      }
      return "";
...
define("modules/crm/views/campaign/unsubscribe", ["exports", "view"], function (
  e,
  t
) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  ...
  class s extends t.default {
    ...
    data() {
      return { isSubscribed: this.isSubscribed, inProcess: this.inProcess };
    }
    setup() {
      super.setup();
      this.actionData = this.options.actionData;
      ...
      this.inProcess = !1;
      let e =
        this.actionData.hash && this.actionData.emailAddress
          ? `Campaign/unsubscribe/${this.actionData.emailAddress}/` +
            this.actionData.hash
          : "Campaign/unsubscribe/" + this.actionData.queueItemId;
      this.addActionHandler("subscribe", () => {
        Espo.Ui.notifyWait();
        this.inProcess = !0;
        this.reRender();
        Espo.Ajax.deleteRequest(e)
          .then(() => {
            this.isSubscribed = !0;
            this.inProcess = !1;
            this.reRender().then(() => {
              var e = this.translate("subscribedAgain", "messages", "Campaign");
              Espo.Ui.notify(e, "success", 0, { closeButton: !0 });
            });
          })
          .catch(() => {
            this.inProcess = !1;
      ...
      this.addActionHandler("unsubscribe", () => {
        ...
        this.inProcess = !0;
        this.reRender();
        Espo.Ajax.postRequest(e)
          .then(() => {
            Espo.Ui.success(
              this.translate("unsubscribed", "messages", "Campaign"),
              { closeButton: !0 }
            );
            this.isSubscribed = !1;
            this.inProcess = !1;
            this.reRender().then(() => {
              var e = this.translate("unsubscribed", "messages", "Campaign");
              Espo.Ui.notify(e, "success", 0, { closeButton: !0 });
            });
          })
          .catch(() => {
...
define("modules/crm/views/campaign/tracking-url", [
  "exports",
  "view",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
...
define("modules/crm/views/campaign/detail", [
  "exports",
  "views/detail",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
...
define("crm:views/campaign/record/detail", ["views/record/detail"], function (
  e
) {
  return e.extend({
    duplicateAction: !0,
        ...
        function (e) {
          ...
          this.listenToOnce(e, "proceed", (e) => {
            ...
            Espo.Ajax.postRequest(
              ...
              Espo.Ui.notify(!1);
              window.open("?entryPoint=download&id=" + e.id, "_blank");
            });
          });
        }
      );
...
define("modules/crm/views/campaign/record/panels/campaign-stats", [
  "exports",
  "views/record/panels/side",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  ...
  class s extends t.default {
    controlStatsFields() {
      var e = this.model.attributes.type;
      let t;
      switch (e) {
        case "Email":
        case "Newsletter":
        ...
        case "Informational Email":
          t = ["sentCount", "bouncedCount"];
          break;
        case "Web":
          t = ["leadCreatedCount", "optedInCount", "revenue"];
          break;
        case "Television":
        case "Radio":
          t = ["leadCreatedCount", "revenue"];
          break;
        case "Mail":
          t = ["sentCount", "leadCreatedCount", "optedInCount", "revenue"];
          break;
        default:
          t = ["leadCreatedCount", "revenue"];
      }
      if (!this.getConfig().get("massEmailOpenTracking")) {
        e = t.indexOf("openedCount");
        -1 < e && t.splice(e, 1);
      }
      ...
      this.getAcl().checkScope("Lead") ||
        this.options.recordViewObject.hideField("leadCreatedCount", !0);
      this.getAcl().checkScope("Opportunity") ||
        this.options.recordViewObject.hideField("revenue", !0);
    }
    setupFields() {
      this.fieldList = [
        "sentCount",
...
define("modules/crm/views/campaign/record/panels/campaign-log-records", [
  "exports",
  "views/record/panels/relationship",
  "helpers/record-modal",
], function (e, t, i) {
  ...
  class a extends t.default {
    ...
    setup() {
      ...
      if (!this.getConfig().get("massEmailOpenTracking")) {
        var e = this.filterList.indexOf("opened");
        0 <= e && this.filterList.splice(e, 1);
      }
      super.setup();
    }
    actionCreateTargetList() {
      ...
      if (this.collection.data.primaryFilter) {
        var t = Espo.Utils.upperCaseFirst(
          this.collection.data.primaryFilter
        ).replace(/([A-Z])/g, " $1");
        e.includingActionList = [t];
      } else e.includingActionList = [];
      t = new i.default();
      t.showCreate(this, {
        ...
        beforeRender: (e) => {
          e.getRecordView().setFieldRequired("includingActionList");
        },
      });
    }
  }
...
define("crm:views/campaign/modals/mail-merge-pdf", [
  "views/modal",
  "ui/select",
], function (e, t) {
  return e.extend({
    ...
    setup: function () {
      ...
      ["contacts", "leads", "accounts", "users"].forEach((e) => {
        if (this.model.get(e + "TemplateId")) {
          var t = this.getMetadata().get([
            "entityDefs",
            "TargetList",
            "links",
...
define("crm:views/campaign/fields/template", ["views/fields/link"], function (
  e
) {
  return e.extend({
    createDisabled: !0,
...
define("crm:views/campaign/fields/int-with-percentage", [
  "views/fields/int",
], function (e) {
  return e.extend({
    getValueForDisplay: function () {
...
define("modules/crm/views/call/detail", [
  "exports",
  "modules/crm/views/meeting/detail",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  e.default = void 0;
  t = ((i = t), i && i.__esModule ? i : { default: i });
...
define("crm:views/call/record/list-expanded", [
  "views/record/list-expanded",
  "crm:views/call/record/list",
], function (e, t) {
  return e.extend({
    actionSetHeld: function (e) {
      t.prototype.actionSetHeld.call(this, e);
...
define("modules/crm/views/call/record/edit-small", [
  "exports",
  "views/record/edit",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
...
define("modules/crm/views/call/record/detail", [
  "exports",
  "views/record/detail",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
...
define("crm:views/call/record/row-actions/default", [
  "views/record/row-actions/view-and-edit",
], function (t) {
  return t.extend({
    getActionList: function () {
...
define("crm:views/call/record/row-actions/dashlet", [
  "views/record/row-actions/view-and-edit",
], function (t) {
  return t.extend({
    getActionList: function () {
...
define("modules/crm/views/call/fields/leads", [
  "exports",
  "modules/crm/views/call/fields/contacts",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  e.default = void 0;
  t = ((i = t), i && i.__esModule ? i : { default: i });
...
define("modules/crm/views/call/fields/date-start", [
  "exports",
  ...
  class a extends t.default {
    ...
    data() {
      ...
      !t ||
        ...
        (this.isDateInPast("dateEnd")
          ? (e = "danger")
          : this.isDateInPast("dateStart") && (e = "warning"));
      return { ...super.data(), style: e };
    }
    isDateInPast(e) {
      var t = this.model.get(e);
      if (t) {
        var t = this.getDateTime().toMoment(t),
          i = (0, s.default)().tz(this.getDateTime().timeZone || "UTC");
        if (t.unix() < i.unix()) return !0;
      }
      return !1;
...
define("modules/crm/views/calendar/mode-buttons", [
  "exports",
  "view",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  ...
  class s extends t.default {
    ...
    data() {
      var e = Espo.Utils.clone(this.scopeList);
      e.unshift("all");
      let i = [];
      this.scopeList.forEach((e) => {
        var t = { scope: e };
        this.getCalendarParentView().enabledScopeList.includes(e) ||
          (t.disabled = !0);
        i.push(t);
      });
      return {
    ...
    getModeDataList(e) {
      ...
      this.modeList.forEach((e) => {
        var t = {
          ...
          labelShort: this.translate(e, "modes", "Calendar").substring(0, 2),
        };
        s.push(t);
      });
      this.isCustomViewAvailable &&
        (this.getPreferences().get("calendarViewDataList") || []).forEach(
          (e) => {
            e = Espo.Utils.clone(e);
            e.mode = "view-" + e.id;
            e.label = e.name;
            e.labelShort = (e.name || "").substring(0, 2);
            s.push(e);
          }
        );
      if (!e) {
    ...
    getVisibleModeDataList() {
      var e = this.getModeDataList(),
        t = e.find((e) => e.mode === this.mode),
        e = e.slice(0, this.visibleModeListCount);
      t && !e.find((e) => e.mode === this.mode) && e.push(t);
      return e;
    }
...
define("modules/crm/views/calendar/calendar-page", [
  "exports",
  "view",
  ...
  class a extends t.default {
    ...
    setup() {
      ...
      if (!this.mode) {
        ...
        if (this.mode && 0 === this.mode.indexOf("view-")) {
    ...
    setupCalendar() {
      var e =
        this.getMetadata().get(["clientDefs", "Calendar", "calendarView"]) ||
        "crm:views/calendar/calendar";
      this.createView(
        "calendar",
        e,
        ...
        (e) => {
          ...
          this.listenTo(e, "change:mode", (e, t) => {
            ...
            if (t) this.updateUrl(!0);
            else {
              ~this.fullCalendarModeList.indexOf(e) || this.updateUrl(!0);
              this.$el.focus();
            }
          });
        }
    ...
    setupTimeline() {
      var e =
        this.getMetadata().get(["clientDefs", "Calendar", "timelineView"]) ||
        "crm:views/calendar/timeline";
      this.createView(
        "calendar",
        e,
    ...
    handleShortcutKeyDigit(e, t) {
      var i = this.getCalendarView().hasView("modeButtons")
      ...
      if (i) {
        ...
        i === this.mode
          ...
          : this.getCalendarView().selectMode(i);
      }
    }
...
define("modules/crm/views/calendar/modals/shared-options", [
  "exports",
  "views/modal",
  "model",
  "views/record/edit-for-modal",
  "crm:views/calendar/fields/users",
], function (e, t, s, a, n) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  e.default = void 0;
  t = i(t);
  ...
  class o extends t.default {
    ...
    setup() {
      this.buttonList = [
        ...
        { name: "cancel", label: "Cancel", onClick: () => this.actionClose() },
      ];
      this.headerText =
        this.translate("timeline", "modes", "Calendar") +
        " · " +
        this.translate("Shared Mode Options", "labels", "Calendar");
      var e = this.options.users;
      let t = [],
        i = {};
      e.forEach((e) => {
        t.push(e.id);
      ...
      this.model = new s.default({ usersIds: t, usersNames: i });
      this.recordView = new a.default({
        model: this.model,
        detailLayout: [
          { rows: [[{ view: new n.default({ name: "users" }) }, !1]] },
        ],
      });
      this.assignView("record", this.recordView);
    }
    actionSave() {
      let i = this.recordView.processFetch();
      if (!this.recordView.validate()) {
        let t = [];
        var e = this.model.attributes.usersIds || [];
        e.forEach((e) => {
          t.push({ id: e, name: (i.usersNames || {})[e] || e });
        });
        this.options.onApply({ users: t });
        this.close();
      }
    }
  }
...
define("modules/crm/views/calendar/modals/edit", [
  "exports",
  "views/modals/edit",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  ...
  class s extends t.default {
    ...
    data() {
      return { scopeList: this.scopeList, scope: this.scope, isNew: !this.id };
    }
    additionalEvents = {
      'change .scope-switcher input[name="scope"]': function () {
        Espo.Ui.notifyWait();
        let i = this.scope,
          s = $('.scope-switcher input[name="scope"]:checked').val();
        this.scope = s;
        this.getModelFactory().create(this.scope, (e) => {
          e.populateDefaults();
          var t = this.getRecordView().fetch(),
            t = { ...t, ...this.getRecordView().model.getClonedAttributes() };
          this.filterAttributesForEntityType(t, s, i);
          e.set(t);
          this.model = e;
    ...
    filterAttributesForEntityType(s, a, e) {
      ("Task" !== a && "Task" !== e) || delete s.reminders;
      this.getHelper()
        ...
        .forEach((e) => {
          if (e in s) {
            var t =
              ...
              i = s[e];
            ~t.indexOf(i) || delete s[e];
          }
        });
    }
    createRecordView(e, t) {
    ...
    afterRender() {
      ...
      if (this.hasView("edit")) {
        var e = this.getView("edit").model;
        e && this.handleAccess(e);
      }
    }
    setup() {
      ...
      if (!this.options.id && !this.options.scope) {
        ...
        if (0 === this.scopeList.length) return this.remove(), void 0;
      }
      super.setup();
      this.id ||
        (this.$header = $("<a>")
...
define("modules/crm/views/admin/entity-manager/fields/status-list", [
  "exports",
  "views/fields/multi-enum",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  ...
  class s extends t.default {
    setupOptions() {
      ...
      this.params.options = [...t];
      this.params.translation = e + ".options.status";
    }
  }
  e.default = s;
});
define("modules/crm/views/activities/list", [
  "exports",
  "views/list-related",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
    ...
    getHeader() {
      var e = this.model.get("name") || this.model.id,
        ...
        e =
          ...
          this.getHelper().getScopeColorIconHtml(this.foreignScope)),
        i = this.getLanguage().translate(this.scope, "scopeNamesPlural");
      let s = $("<span>").text(i);
...
define("modules/crm/views/account/detail", [
  "exports",
  "views/detail",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
...
define("modules/crm/views/account/fields/shipping-address", [
  "exports",
  ...
  class s extends t.default {
    ...
    setup() {
      ...
      this.listenTo(this.model, "change", () => {
        let e = !1;
        for (var t of this.allAddressAttributeList)
          if (this.model.hasChanged(t)) {
            e = !0;
            break;
          }
        e &&
    ...
    afterRender() {
      ...
      if (this.mode === this.MODE_EDIT && this.element) {
        var e = this.translate("Copy Billing", "labels", "Account"),
          t = (this.copyButtonElement = document.createElement("button"));
        t.classList.add("btn", "btn-default", "btn-sm", "action");
        t.textContent = e;
        t.setAttribute("data-action", "copyFromBilling");
        this.toShowCopyButton() || t.classList.add("hidden");
    ...
    copy() {
      let s = this.copyFrom;
      Object.keys(
        this.getMetadata().get("fields.address.fields") || {}
      ).forEach((e) => {
        var t = this.name + Espo.Utils.upperCaseFirst(e),
          i = s + Espo.Utils.upperCaseFirst(e);
        this.model.set(t, this.model.get(i));
      });
    }
    toShowCopyButton() {
      let i = !1,
...
define("modules/crm/view-setup-handlers/document/record-list-drag-n-drop", [
  "exports",
  "underscore",
  "bullbone",
], function (e, t, i) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  e.default = void 0;
  t = ((s = t), s && s.__esModule ? s : { default: s });
  var s;
  function a(e) {
    this.view = e;
  }
  t.default.extend(a.prototype, {
    process: function () {
      this.listenTo(this.view, "after:render", () => this.initDragDrop());
      this.listenTo(this.view, "remove", () => this.disable());
    },
    disable: function () {
      var e = this.view.$el.parent(),
        t = e.get(0);
      e.off("drop");
      if (t && this.onDragoverBind) {
    ...
    create: function (s) {
      this.view.actionQuickCreate().then((e) => {
        ...
        if (t)
          ...
          var i = "No 'file' field on the layout.";
          Espo.Ui.error(i);
          console.error(i);
        }
      });
    ...
    onDragleave: function (e) {
      ...
      if (this.dropEntered) {
        ...
        (t && $.contains(this.view.$el.parent().get(0), t)) ||
          (t &&
            t.parentNode &&
            "[object ShadowRoot]" === t.parentNode.toString()) ||
          this.removeDrop();
      }
    },
  });
...
define("modules/crm/handlers/task/reminders-handler", [
  "exports",
  "bullbone",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  ...
  class i {
    constructor(e) {
      ...
      this.ignoreStatusList = [
        ...(this.view
          .getMetadata()
          .get(["scopes", this.view.entityType, "completedStatusList"]) || []),
        ...(this.view
          .getMetadata()
          .get(["scopes", this.view.entityType, "canceledStatusList"]) || []),
      ];
    }
    process() {
      this.control();
    ...
    control() {
      if (this.model.attributes.dateEnd || this.model.attributes.dateEndDate) {
        var e = this.model.attributes.assignedUsersIds || [];
        this.ignoreStatusList.includes(this.model.attributes.status) ||
        (this.model.attributes.assignedUserId !== this.user.id &&
          !e.includes(this.user.id))
          ? this.view.hideField("reminders")
          : this.view.showField("reminders");
      } else this.view.hideField("reminders");
    }
  }
  Object.assign(i.prototype, t.Events);
  e.default = i;
});
define("modules/crm/handlers/task/menu", [
  "exports",
  "action-handler",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  ...
  class s extends t.default {
    complete() {
      ...
      e.save({ status: "Completed" }, { patch: !0 }).then(() => {
        Espo.Ui.success(
          this.view.getLanguage().translateOption("Completed", "status", "Task")
        );
      });
    }
    isCompleteAvailable() {
...
define("modules/crm/handlers/task/detail-actions", [
  "exports",
  "action-handler",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
...
define("modules/crm/handlers/opportunity/defaults-preparator", [
  "exports",
  "handlers/model/defaults-preparator",
  "metadata",
  "di",
], function (e, t, i, s) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  ...
  function l(r, t, c, i, h, e) {
    var I,
      ...
      p,
      s,
      a = Symbol.metadata || Symbol.for("Symbol.metadata"),
    ...
    function O(s, a, n) {
      return function (e, t) {
        a && ((t = e), (e = r));
        for (var i = 0; i < s.length; i++) t = s[i].apply(e, n ? [t] : []);
        return n ? t : e;
      };
    }
    function N(e, t, i, s) {
      ...
      throw new TypeError(
        t + " must " + (i || "be") + " a function" + (s ? "" : " or undefined")
      );
    }
    function f(n, t, e, i, s, a, o, l, d, r, c) {
      function h(e) {
        if (!c(e))
          throw new TypeError(
      ...
      function w(i, s, a) {
        return function (e, t) {
          return s && ((t = e), (e = n)), a && a(e), b[i].call(e, t);
        };
      }
      if (!p) {
        var b = {},
          L = [],
          A = g ? "get" : v || f ? "set" : "value";
        if (
          (d
            ? (r || f
                ? (b = {
                ...
                : (b[A] = m),
              r || P(b[A], i, y ? "" : A))
            : r || (b = Object.getOwnPropertyDescriptor(n, i)),
          !r && !d)
        ) {
          if ((k = _[+l][i]) && 7 != (k ^ s))
            throw Error(
      ...
      for (var T = n, x = u.length - 1; 0 <= x; x -= e ? 2 : 1) {
        var M = N(u[x], "A decorator", "be", !0),
          C = e ? u[x - 1] : void 0,
          S = {},
          E = {
            ...
            addInitializer: function (e, t) {
              ...
              N(t, "An initializer", "be", !0), a.push(t);
            }.bind(null, S),
          };
        if (p)
          (k = M.call(C, T, E)),
            (S.v = 1),
            N(k, "class decorators", "return") && (T = k);
        else if (
          ((E.static = l),
          (E.private = d),
          (k = E.access =
          ...
          (T = M.call(C, f ? { get: b.get, set: b.set } : b[A], E)),
          (S.v = 1),
          f)
        ) {
          if ("object" == typeof T && T)
            (k = N(T.get, "accessor.get")) && (b.get = k),
              (k = N(T.set, "accessor.set")) && (b.set = k),
              (k = N(T.init, "accessor.init")) && L.unshift(k);
          else if (void 0 !== T)
            throw new TypeError(
              "accessor decorators must return an object with get, set, or init properties or undefined"
            );
        } else
          N(T, (r ? "field" : "method") + " decorators", "return") &&
            (r ? L.unshift(T) : (b[A] = T));
      }
      return (
        s < 2 && o.push(O(L, l, 1), O(a, l, 0)),
        r ||
          p ||
          (d
            ? f
              ? o.splice(-1, 0, w("get", l), w("set", l))
              : o.push(y ? b[A] : N.call.bind(b[A]))
            : D(n, i, b)),
        T
      );
    }
    function l(e) {
      return D(e, a, { configurable: !0, enumerable: !0, value: I });
    }
    return (
      void 0 !== e && (I = e[a]),
      (I = n(null == I ? null : I)),
      ...
      o || l(r),
      {
        ...
        get c() {
          var e = [];
          return o && [l((r = f(r, [t], i, r.name, 5, e))), O(e, 1)];
        },
      }
    );
  }
  ...
  class d extends t.default {
    static #_ = ([a, n] = l(
      this,
      [],
      [[(0, s.inject)(i.default), 0, "metadata"]],
      0,
      void 0,
      t.default
    ).e);
    ...
    prepare(e) {
      var t =
        ...
        i = e.attributes.stage,
        s = {};
      i in t && (s.probability = t[i]);
      return Promise.resolve(s);
    }
  }
  e.default = d;
});
define("modules/crm/handlers/opportunity/contacts-create", [
  "exports",
  "handlers/create-related",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  e.default = void 0;
  t = ((i = t), i && i.__esModule ? i : { default: i });
...
define("modules/crm/handlers/knowledge-base-article/send-in-email", [
  "exports",
  "handlers/row-action",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  ...
  class s extends t.default {
    ...
    process(s, e) {
      let a = this.view.getParentView().model,
      ...
      s.fetch()
            ...
            new Promise((i) => {
              a.get("contactsIds") && a.get("contactsIds").length
                ? n.create("Contact", (e) => {
                    ...
                    e.fetch().then(() => {
                      e.forEach((e) => {
                        e.id === a.get("contactId") ? t.unshift(e) : t.push(e);
                      });
                      i(t);
                    });
                  })
        ...
        .then((e) => {
          ...
          Espo.loader.require("crm:knowledge-base-helper", (e) => {
            var t = new e(this.view.getLanguage());
...
define("modules/crm/handlers/knowledge-base-article/move", [
  "exports",
  "handlers/row-action",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
...
define("modules/crm/handlers/event/reminders-handler", [
  "exports",
  "bullbone",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
...
define("modules/crm/handlers/case/detail-actions", [
  "exports",
  "action-handler",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  ...
  class s extends t.default {
    ...
    isStatusAvailable(e) {
      ...
      return !(
        a.includes(t.get("status")) ||
        !i.check(t, "edit") ||
        !i.checkField(t.entityType, "status", "edit") ||
        ((a =
...
define("modules/crm/handlers/campaign/mass-emails-create", [
  "exports",
  "handlers/create-related",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
...
define("modules/crm/controllers/unsubscribe", [
  "exports",
  "controller",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
...
define("modules/crm/controllers/tracking-url", [
  "exports",
  "controller",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
...
define("modules/crm/controllers/task", [
  "exports",
  "controllers/record",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  ...
  class s extends t.default {
    actionCreate(e) {
      ...
      super.actionCreate(e);
    }
  }
  e.default = s;
});
define("modules/crm/controllers/lead", [
  "exports",
  "controllers/record",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
...
define("modules/crm/controllers/event-confirmation", [
  "exports",
  "controller",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
...
define("modules/crm/controllers/calendar", ["exports", "controller"], function (
  e,
  t
) {
  Object.defineProperty(e, "__esModule", { value: !0 });
...
define("modules/crm/controllers/activities", [
  "exports",
  "controller",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  ...
  class s extends t.default {
    ...
    actionActivities(e) {
      this.processList("activities", e.entityType, e.id, e.targetEntityType);
    }
    actionHistory(e) {
    ...
    processList(t, i, s, a) {
      ...
      this.modelFactory
        ...
        .then((e) => {
          n = e;
          n.id = s;
          return n.fetch({ main: !0 });
        })
        .then(() => this.collectionFactory.create(a))
        .then((e) => {
          e.url =
            "Activities/" + n.entityType + "/" + s + "/" + t + "/list/" + a;
...
define("modules/crm/acl-portal/document", ["exports", "acl-portal"], function (
  e,
  t
) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  ...
  class s extends t.default {
    checkModelEdit(e, t, i) {
      var s = this.checkModel(e, t, "delete", i);
      return !!s || "account" === t.edit;
    }
  }
  e.default = s;
});
define("modules/crm/acl-portal/contact", ["exports", "acl-portal"], function (
  e,
  t
) {
  Object.defineProperty(e, "__esModule", { value: !0 });
...
define("modules/crm/acl-portal/account", ["exports", "acl-portal"], function (
  e,
  t
) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  ...
  class s extends t.default {
    checkInAccount(e) {
      var t = this.getUser().getLinkMultipleIdList("accounts");
...
define("modules/crm/acl/mass-email", ["exports", "acl"], function (e, t) {
  ...
  class s extends t.default {
    checkScope(e, t, i, s) {
      return "create" === t
        ? super.checkScope(e, "edit", i, s)
        : super.checkScope(e, t, i, s);
    }
    checkIsOwner(e) {
...
define("modules/crm/acl/campaign-tracking-url", ["exports", "acl"], function (
  e,
  t
) {
  Object.defineProperty(e, "__esModule", { value: !0 });
...
define("modules/crm/acl/call", [
  "exports",
  "modules/crm/acl/meeting",
], function (e, t) {
  Object.defineProperty(e, "__esModule", { value: !0 });
  e.default = void 0;
  t = ((i = t), i && i.__esModule ? i : { default: i });
